...
namespace Game.TestInfrastructure.Helpers
{
    ...
    /// that must be locale-independent (e.g. the codegen's byte-compared output) can be pinned against
    /// a culture whose casing/collation differs from the invariant one.
