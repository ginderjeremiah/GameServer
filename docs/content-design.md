...
- **Tutorials — landing.** The arc leans on **tutorial blurbs** as a teaching lane (§2); the feature is scoped in spike **[#1392](https://github.com/ginderjeremiah/GameServer/issues/1392)** (lessons are Workbench-authored reference data, presented as an anchored coach-mark tour). The reference-data entity and Workbench authoring landed in #1591; the client-side trigger evaluation, per-player state, and tour component are still landing (#1587/#1588/#1592).
