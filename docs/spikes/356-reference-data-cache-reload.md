...
- **[#357](https://github.com/ginderjeremiah/GameServer/issues/357)** _(tech debt, claude)_ — Eagerly load reference-data caches at startup, failing fast at boot. Small, standalone first slice; uses the existing fill path.
