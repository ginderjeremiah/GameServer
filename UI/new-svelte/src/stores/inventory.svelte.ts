...
const updateInventorySlots = () => {
	const inv = [
		...inventoryItems.flatMap((slot) =>
			slot.item
				? { id: slot.item.id, inventorySlotNumber: slot.item.inventorySlotNumber, equipped: false }
				: []
		),
		...equippedItems.flatMap((slot) =>
			slot.item
	...
	// const inv = [
	//    ...inventoryItems.mapNotNull((slot) => slot.item ? { id: slot.item.id, inventorySlotNumber: slot.item.inventorySlotNumber, equipped: false } : null),
	//    ...equippedItems.mapNotNull((slot) => slot.item ? { id: slot.item.id, inventorySlotNumber: slot.item.inventorySlotNumber, equipped: true } : null)
	// ];
