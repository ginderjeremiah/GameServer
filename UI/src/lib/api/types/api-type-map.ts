...
export type ApiResponseTypes = {
	...
	'Auth': ILoginResult;
	'Auth/ActiveSession': IActiveSessionResult;
	'Auth/CreateAccount': undefined;
	'Auth/DeviceInfo': undefined;
	'Auth/Logout': undefined;
	'Auth/Refresh': IAuthTokens;
	'Auth/Status': IPlayerData;
	'Players': IPlayerSummary[];
	'Players/CharacterCreationData': ICreatableClass[];
	'Players/CreatePlayer': IPlayerSummary;
	'Players/SelectPlayer': ISelectPlayerResult;
	'Players/SwitchPlayer': ISelectPlayerResult;
	'Tags': ITag[];
...
export type ApiRequestTypes = {
	...
	'Auth/Refresh': IRefreshRequest;
	'Players/CreatePlayer': ICreatePlayerRequest;
	'Players/SelectPlayer': ISelectPlayerRequest;
	'Players/SwitchPlayer': ISelectPlayerRequest;
};
