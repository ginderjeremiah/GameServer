...
describe('AttributeBreakdownView', () => {
	...
	it('groups the displayed attributes by display taxonomy (Primary / Secondary), sorted by display order', () => {
		...
		// CriticalDamage (base 1.5) and DodgeChance (Agility-derived) remain too, as does ParryChanceMultiplier
		// (base 1, #1457 — the same opt-in-multiplier shape as CriticalChanceMultiplier).
