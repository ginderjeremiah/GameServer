...
/* Shared `IEnemy` contract builder (#2446). Every typed `IEnemy` under `src/tests/` builds through
   here — there are no standing exclusions. See `docs/frontend.md` → Testing Guidelines for the
   contract-drift rule. */
