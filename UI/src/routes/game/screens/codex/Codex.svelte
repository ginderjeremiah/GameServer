<!-- Codex screen — a read-only reference glossary (bestiary / atlas / skill catalogue). The Enemies and
     Zones tabs are built; Skills is a placeholder. Per-entity player statistics live in the enemy
