namespace Game.Api.Models.Progress
{
    ...
    public class ProficiencyXpGainedModel : IModel
    {
        ...
        /// <summary>The nodes this battle opened (a maxed tier's next tier within its path), so the client
        /// surfaces the newly-revealed proficiency immediately.</summary>
    ...
    /// <summary>A node the battle opened (a maxed tier's next tier within its path).</summary>
