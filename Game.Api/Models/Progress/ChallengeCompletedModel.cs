namespace Game.Api.Models.Progress
{
    ...
    /// usable immediately (equip the item/mod, select the skill) without a page refresh. The reward ids
    /// are null when the challenge carries no reward of that kind.
    /// </summary>
