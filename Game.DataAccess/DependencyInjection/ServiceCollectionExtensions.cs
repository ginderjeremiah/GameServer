    ...
    public static class ServiceCollectionExtensions
    {
        ...
        public static IServiceCollection AddDataAccess(this IServiceCollection services)
        {
            ...
            return services.AddTransient<InfrastructureOptions>(sp => sp.GetRequiredService<IOptions<DataAccessOptions>>().Value)
                ...
                .AddSingleton<ClassesCacheHolder>()
                .AddSingleton<IReloadableReferenceCache>(sp => sp.GetRequiredService<ClassesCacheHolder>())
                .AddScoped<Classes>()
                .AddScoped<IClasses>(sp => sp.GetRequiredService<Classes>())
                .AddScoped<IClassEntityCache>(sp => sp.GetRequiredService<Classes>())
                ...
                .AddSingleton<LessonsCacheHolder>()
                .AddSingleton<IReloadableReferenceCache>(sp => sp.GetRequiredService<LessonsCacheHolder>())
                .AddScoped<Lessons>()
                .AddScoped<ILessons>(sp => sp.GetRequiredService<Lessons>())
                .AddScoped<ILessonEntityCache>(sp => sp.GetRequiredService<Lessons>())
                ...
                .AddSingleton<ProficienciesCacheHolder>()
                .AddSingleton<IReloadableReferenceCache>(sp => sp.GetRequiredService<ProficienciesCacheHolder>())
                .AddScoped<Proficiencies>()
                .AddScoped<IProficiencies>(sp => sp.GetRequiredService<Proficiencies>())
                .AddScoped<IProficiencyEntityCache>(sp => sp.GetRequiredService<Proficiencies>())
                .AddSingleton<SkillRecipesCacheHolder>()
                .AddSingleton<IReloadableReferenceCache>(sp => sp.GetRequiredService<SkillRecipesCacheHolder>())
                .AddScoped<SkillRecipes>()
                .AddScoped<ISkillRecipes>(sp => sp.GetRequiredService<SkillRecipes>())
                .AddScoped<ISkillRecipeEntityCache>(sp => sp.GetRequiredService<SkillRecipes>())
                .AddScoped<Tags>()
                ...
                .AddScoped<IAdminClasses, AdminClasses>()
                ...
                .AddScoped<IAdminSkillRecipes, AdminSkillRecipes>()
                .AddScoped<IAdminLessons, AdminLessons>()
