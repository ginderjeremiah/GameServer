namespace Game.Infrastructure.Entities
{
    public class Item : IZeroBasedIdentityEntity
    {
        ...
        /// <summary>The <see cref="Core.EDamageType"/> leaf this weapon deals, stored as its enum value, or
        /// null for a non-weapon item — any leaf is valid (a caster weapon declares its element). Only
        /// meaningful on a <see cref="Core.EItemCategory.Weapon"/> item; the admin save requires a weapon to
        /// declare both this and a <see cref="GrantedSkillId"/> whose own type is fieldable with it.</summary>
