...
namespace GameInfrastructure.Migrations
{
    ...
    [Migration("20241025022449_InventoryItemUniqueRestraint")]
    partial class InventoryItemUniqueRestraint
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GameCore.Entities.ItemModSlot", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GameCore.Entities.ItemModSlotType", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GameCore.Entities.InventoryItemMod", b =>
                {
                    ...
                    b.HasOne("GameCore.Entities.ItemModSlot", "ItemModSlot")
                        .WithMany("InventoryItemMods")
            ...
            modelBuilder.Entity("GameCore.Entities.ItemMod", b =>
                {
                    b.HasOne("GameCore.Entities.ItemModSlotType", "SlotType")
                        .WithMany("ItemMods")
            ...
            modelBuilder.Entity("GameCore.Entities.ItemModSlot", b =>
                {
                    ...
                    b.HasOne("GameCore.Entities.ItemModSlotType", "ItemModSlotType")
                        .WithMany("ItemModSlots")
