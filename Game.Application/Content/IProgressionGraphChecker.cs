namespace Game.Application.Content
{
    ...
    /// CI lint over the committed <c>content/*.json</c> export and (eventually) a read-only admin Content Health
    /// view; both build a <see cref="ContentGraph"/> and run it through here.
    /// </summary>
