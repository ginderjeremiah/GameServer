...
namespace Game.Core.Attributes
{
    ...
    public static class DamageTypes
    {
        ...
        /// <summary>Every distinct defender-side resistance attribute (one per non-weapon key), in canonical key
        /// order — the single source a battler snapshots at construction for the Hex innate-resistance baseline
        /// (#1427). The amplification-only weapon keys drop out (null Resistance).</summary>
        public static IReadOnlyList<EAttribute> ResistanceAttributesAll { get; } =
