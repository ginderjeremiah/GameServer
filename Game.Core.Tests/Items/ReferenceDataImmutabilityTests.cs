...
namespace Game.Core.Tests.Items
{
    ...
    public class ReferenceDataImmutabilityTests
    {
        ...
        /// <see cref="CorePath"/> is a separate root because it is shared via the proficiency cache's
        /// activity-key → paths routing lookup rather than being reachable from the <see cref="Proficiency"/>
        /// graph.
        /// </summary>
