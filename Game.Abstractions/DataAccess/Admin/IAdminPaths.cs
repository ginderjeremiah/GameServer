...
{
    /// <summary>
    /// Content Authoring persistence for paths (the proficiency sequences, each declaring the activity key it
    /// trains on). Encapsulates the EF specifics behind an entity-free admin contract surface.
    /// </summary>
