...
namespace Game.Abstractions.DataAccess.Admin
{
    ...
    public interface IAdminChallenges
    {
        ...
        /// Fails (applying nothing) if an edit targets a challenge that does not exist.</summary>
        AdminSaveResult SaveChallenges(IReadOnlyList<Change<Challenge>> changes);
    }
}
